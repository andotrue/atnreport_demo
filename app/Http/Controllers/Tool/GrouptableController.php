...
class GrouptableController extends Controller {
	...
	public $functionName = "ユーザーグループ管理";
	...
	{
		$grouptables = Grouptable::orderBy('parent_user_id', 'asc')->paginate(25);

		$this->data = compact('grouptables');

		$this->setFunctionName();

		return view('tool.grouptable.index', $this->data);
	}
	...
	public function create()
	{
		...
		return view('tool.grouptable.create', $this->data);
	}
